...
# Train PPO agent
model = DQN('MlpPolicy', env, verbose=0, learning_rate=0.001, exploration_final_eps=0.001, tensorboard_log = None, gamma=0.15)
# model = PPO('CnnPolicy', env, verbose=1,)
# model = PPO('MlpPolicy', env, verbose=1, learning_rate=0.001, n_steps=2048, batch_size=64,ent_coef=0.01,n_epochs=1,tensorboard_log=None)
...
for episode in range(1,num_episodes+1):
    ...
    # Train agent
    model.learn(total_timesteps=epi_step,reset_num_timesteps=False)
