...
routefile_path = "working/gen_route_2.rou.xml"
...
# Train PPO agent
model = DQN('MlpPolicy', env, verbose=0, learning_rate=0.001, exploration_final_eps=0.001, tensorboard_log = None, gamma=0.01)
...
#     file_path = f'/home/poison/RL/Final/working/tripinfo_epi{episode}.xml'
